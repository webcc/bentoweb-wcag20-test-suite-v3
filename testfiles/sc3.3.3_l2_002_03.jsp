...
if(toChange || toSave ){
 ...
 if (request.getMethod().equals("POST")) {
    ...
    if (!error) {
		...
		if(!toSave){
		    if(!toChange){
				response.sendRedirect("sc3.3.3_l2_002_04.jsp");
		    }
		}else{
		    response.sendRedirect("sc3.3.3_l2_002_04.jsp");
		}
...
<link rel="stylesheet" media="screen,projection"
	href="resources/css/sc3.3.css" type="text/css" />
...
<form method="post" action="sc3.3.3_l2_002_03.jsp">
<div><label for="id1" class="leftcollarge">Transfer amount
(in Euro) *</label><input type="text" name="tamount" id="tamount"
	value="<%= tamount!=null?tamount:"" %>" /><br />
<br />
<div class="space"><input type="submit" name="submit"
	value="<%=submit%>" /><br />
</div>
</div>
</form>
