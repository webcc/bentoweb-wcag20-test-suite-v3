...
if(request.getMethod().equals("POST")){
    ...
    if(restoredBooks != null){
        ...
        response.sendRedirect("sc3.3.6_l3_003_01.jsp");
    }
}
...
%><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <body>
    ...
    <form method="post" action="sc3.3.6_l3_003_02.jsp">
    <div>
    <% 
    if(books.size() > 0){
   	%><h2>Removed Books:</h2>
	...
	<div class="space"><a href="sc3.3.6_l3_003_01.jsp">To shopping cart.</a><br/></div>
	</div>
	</form>
  </body>
