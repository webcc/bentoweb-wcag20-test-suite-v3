...
List removedBookList = (List)session.getAttribute("removedbooks");
if(removedBookList == null){
    removedBookList = new ArrayList<String>();
    session.setAttribute("removedbooks", removedBookList);
}
...
%><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <body>
	<h1>Shopping cart items - to buy now</h1>
    <form method="post" action="sc3.3.6_l3_004_01.jsp">
    <div>
    <% 
    if(books.size() > 0){
   	%><h2>Books:</h2><%
