...
if(request.getMethod().equals("POST")){
    ...
    if(removedBooks != null){
        ...
        response.sendRedirect("sc3.3.6_l3_003_02.jsp");
    }
}else{
    if(removedBookList != null){
...
%><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <body>
	<h1>Shopping Cart</h1>
    <form method="post" action="sc3.3.6_l3_003_01.jsp">
    <div>
    <% 
    if(books.size() > 0){
	...
	<div class="space"><a href="sc3.3.6_l3_003_02.jsp">View removed books.</a><br/></div>
	</div>
	</form>
  </body>
